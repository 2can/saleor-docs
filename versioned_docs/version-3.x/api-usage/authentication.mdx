...
See the [Saleor SDK documentation](https://github.com/saleor/saleor-app-sdk/blob/main/docs/app-bridge.mdx#events) for more details on how to receive the token.
